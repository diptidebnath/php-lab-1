...
?>
  ...
  <main>
    ...
    <section class="text-center text-dark">
      <div class="container">
        <h2 class="display-4">View all movies</h2>
        <p class="lead">Mauris in sem non mi bibendum accumsan. Suspendisse potenti. Aenean finibus molestie
          commodo. Nullam auctor mi vestibulum enim auctor molestie. Pellentesque fringilla facilisis elementum. Morbi
          vitae lobortis arcu, at sollicitudin velit.</p>
        <p>
          <a href="contacts.html" class="btn btn-primary my-2 portfolio-btn">Now showing</a>
          <a href="contacts.html" class="btn btn-secondary my-2 portfolio-btn">Upcoming movie</a>
        </p>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card mb-4 shadow-sm">
              <img src="/lab1/asset/img/kungfu.jpg" class="img-fluid" alt="project1">
              <div class="card-body">
                <h4>Kung Fu Panda</h4>
                <p>7+ | 2h 3m</p>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                     <button type="button" onclick="window.location.href='#book-now';" class="btn btn-sm btn-outline-secondary">Book Now!</button>
    ...
    <section class="text-center bg-primary text-dark">
      <div class="container">
        <h2 id="book-now" class="display-3">Book your ticket here!</h2>
